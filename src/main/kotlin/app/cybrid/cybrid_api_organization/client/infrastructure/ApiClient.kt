...
import app.cybrid.cybrid_api_organization.client.auth.OAuth.AccessTokenListener
import app.cybrid.cybrid_api_organization.client.auth.OAuthFlow
import app.cybrid.cybrid_api_organization.client.auth.HttpBearerAuth
...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth = when (authName) {
                "BearerAuth" -> HttpBearerAuth("bearer")"oauth2" -> OAuth(OAuthFlow.application, "", "https://id.production.cybrid.app/oauth/token", "organizations:write, organizations:read, subscriptions:write, subscriptions:read, subscriptions:execute, subscription_events:read, subscription_events:execute")
    ...
    */
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "app.cybrid.cybrid_api_organization.client.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://organization.sandbox.cybrid.app")
        }
    }
}
