 ...
 * 
 *
 * @param guid Auto-generated unique identifier for the organization.
 * @param name Name provided for the organization.
 * @param createdAt ISO8601 datetime the organization was created at.
 */

data class OrganizationOrganizationModel (
