 ...
 *
 * The version of the OpenAPI document: v0.123.166
 ...
 * @param state The state of the subscription; one of storing, completed, or failed.
 * @param organizationGuid The organization guid for the subscription.
 * @param signingKey Subscription private signing key.
 * @param deliveriesFailingSince ISO8601 datetime the deliveries started failing.
...
data class SubscriptionOrganizationModel (
    ...
    val signingKey: kotlin.String? = null,

    /* ISO8601 datetime the deliveries started failing. */
    @SerializedName("deliveries_failing_since")
    val deliveriesFailingSince: java.time.OffsetDateTime? = null,
